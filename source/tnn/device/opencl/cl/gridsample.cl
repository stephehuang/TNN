...
__kernel void BilinearGridSample(GLOBAL_SIZE_2_DIMS __read_only image2d_t input,
    ...
    FLOAT4 input_data_nw =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + nw_index_x, output_b_idx * input_height + nw_index_y));
    ...
    FLOAT4 input_data_ne =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + ne_index_x, output_b_idx * input_height + ne_index_y));
    ...
    FLOAT4 input_data_sw =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + sw_index_x, output_b_idx * input_height + sw_index_y));
    ...
    FLOAT4 input_data_se =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + se_index_x, output_b_idx * input_height + se_index_y));
    res = res + input_data_se * se.x;
    WI_F(output, (int2)((output_c_block_idx * out_width + output_w_idx), output_b_idx * out_height + output_h_idx), res);
    ...
    res = (FLOAT4)(0, 0, 0, 0);
    input_data_nw =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + nw_index_x, output_b_idx * input_height + nw_index_y));
    ...
    input_data_ne =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + ne_index_x, output_b_idx * input_height + ne_index_y));
    ...
    input_data_sw =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + sw_index_x, output_b_idx * input_height + sw_index_y));
    ...
    input_data_se =  RI_F(input, SAMPLER, (int2)(output_c_block_idx * input_width + se_index_x, output_b_idx * input_height + se_index_y));
    res = res + input_data_se * se.y;
    WI_F(output, (int2)((output_c_block_idx * out_width + output_w_idx), output_b_idx * out_height + output_h_idx + 1), res);
    ...
    WI_F(output, (int2)((output_c_block_idx * out_width + output_w_idx), output_b_idx * out_height + output_h_idx + 2), res);
    ...
    WI_F(output, (int2)((output_c_block_idx * out_width + output_w_idx), output_b_idx * out_height + output_h_idx + 3), res);
}
